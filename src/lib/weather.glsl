...
const WeatherDay moonPhaseRampColors[MOON_PHASES] = WeatherDay[](
	WeatherDay(vec3(0.090, 0.197, 0.174), 6.410, .6410, 0.71),
	WeatherDay(vec3(0.239, 0.419, 0.248), 8.659, .8659, 0.52),
	WeatherDay(vec3(0.230, 0.299, 0.185), 21.28, 2.128, 0.06),
	WeatherDay(vec3(0.102, 0.269, 0.212), 23.74, 2.374, 0.57),
	WeatherDay(vec3(0.066, 0.091, 0.146), 15.21, 1.521, 0.52),
	WeatherDay(vec3(0.220, 0.334, 0.255), 15.70, 1.570, 0.41),
	WeatherDay(vec3(0.058, 0.095, 0.104), 12.68, 1.268, 0.51),
	WeatherDay(vec3(0.099, 0.146, 0.091), 6.341, .6341, 0.26),
	WeatherDay(vec3(0.357, 0.427, 0.168), 5.634, .5634, 0.92),
	WeatherDay(vec3(0.101, 0.165, 0.138), 16.83, 1.683, 0.61),
	WeatherDay(vec3(0.183, 0.385, 0.361), 13.20, 1.320, 0.10),
	WeatherDay(vec3(0.208, 0.371, 0.211), 10.45, 1.045, 0.93),
	WeatherDay(vec3(0.099, 0.192, 0.253), 23.45, 2.345, 0.24),
	WeatherDay(vec3(0.235, 0.385, 0.324), 8.899, .8899, 0.65),
	WeatherDay(vec3(0.264, 0.430, 0.416), 22.38, 2.238, 0.43),
	WeatherDay(vec3(0.096, 0.121, 0.148), 5.744, .5744, 0.53),
	WeatherDay(vec3(0.096, 0.119, 0.078), 22.56, 2.256, 0.96),
	WeatherDay(vec3(0.319, 0.391, 0.190), 22.28, 2.228, 0.61),
	WeatherDay(vec3(0.172, 0.304, 0.258), 23.38, 2.338, 0.63),
	WeatherDay(vec3(0.235, 0.351, 0.200), 13.33, 1.333, 0.62),
	WeatherDay(vec3(0.182, 0.276, 0.118), 7.878, .7878, 0.88),
	WeatherDay(vec3(0.141, 0.330, 0.315), 20.86, 2.086, 0.58),
	WeatherDay(vec3(0.067, 0.107, 0.193), 8.538, .8538, 0.58),
	WeatherDay(vec3(0.098, 0.181, 0.283), 12.40, 1.240, 0.74),
	WeatherDay(vec3(0.244, 0.434, 0.486), 23.98, 2.398, 0.98),
	WeatherDay(vec3(0.221, 0.266, 0.344), 8.983, .8983, 0.22),
	WeatherDay(vec3(0.066, 0.189, 0.114), 21.84, 2.184, 0.33),
	WeatherDay(vec3(0.161, 0.230, 0.140), 15.33, 1.533, 0.63),
	WeatherDay(vec3(0.395, 0.461, 0.244), 20.12, 2.012, 0.86),
	WeatherDay(vec3(0.189, 0.461, 0.301), 19.15, 1.915, 0.59),
	WeatherDay(vec3(0.076, 0.100, 0.058), 17.25, 1.725, 0.12),
	WeatherDay(vec3(0.110, 0.139, 0.214), 13.00, 1.300, 0.59)
);
